...
learning_rate = 0.000001  # Example learning rate
weight_decay = 0.000000001  # Example weight decay
...
model.compile(optimizer=adamw_optimizer, loss=binary_focal_loss(gamma=3., alpha=0.25), metrics=['accuracy', 'AUC'])
# model.summary()
