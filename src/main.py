...
from frame1_unet import frame1_unet

# Tensorboard Command:
# tensorboard --logdir=./results/frame1_unet/logs
...
resultsFolder = './results/frame1_unet'
...
dataset_train = dataset_func(os.path.join(dataFolder, 'train'), BATCH_SIZE, 1) #mode=1
dataset_test = dataset_func(os.path.join(dataFolder, 'test'), BATCH_SIZE, 1) #mode=1
