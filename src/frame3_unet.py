...
frame3_unet = keras.models.Model(inputs=inputs, outputs=outputs, name="3frame_unet_model")

dot_img_file = 'tmp/frame3_unet.png'
keras.utils.plot_model(frame3_unet, to_file=dot_img_file, show_shapes=True)